...
\begin{multicols}{3}
	\begin{minipage}{\dimexpr2\columnwidth+\columnsep\relax}
		...
		\paragraph{What even is \flowr}\flowr{} is a static \emph{dataflow analyzer} and
		...
		variable. For now, Florian and I decided to limit ourselves to determining the
		\emph{domain of numeric variables}. In other words, we want to know what values
		a variable can have at a certain point in the program.
