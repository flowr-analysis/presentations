...
\makeatletter\tikzset{
	...
	t/.style={roundednode,dashed,node on layer=background,inner sep=2mm,fill=lightgray!20,fill opacity=0.9,minimum width=\columnwidth-\smile@linewidth,minimum height=4.2cm},
	dr/.style={pill},
...
if (a < 100) {
	...
	b <- b + 2
		...
		\begin{multicols}{2}
			...
			\end{tikzpicture}\par
			\paragraph{Fig. 2} The computed interval for each variable at every line.
		\end{multicols}\bigskip
		\endgroup
		\lipsum[1-2]
